...
While Sloppy Noto should work with any csv-like data files containing large quantities of numeric data, it was created primarily to create audio from the raw datasets of various space missions of [ESA](https://www.esa.int/) and [NASA](https://nasa.gov).
